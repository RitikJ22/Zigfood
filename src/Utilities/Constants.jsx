...
export const FETCH_ADDRESS_URL = "https://www.swiggy.com/dapi/misc/address-recommend?place_id=";
export const REST_MENU_URL = "https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true";
export const ADDRESS_SUGG_URL = "https://www.swiggy.com/dapi/misc/place-autocomplete?input=";
export const SEARCH_REST_URL = "https://www.swiggy.com/dapi/restaurants/search/suggest?";
export const FETCH_HOME_DATA_URL = "https://www.swiggy.com/dapi/restaurants/list/v5?";
export const FETCH_MORE_DATA_URL = "https://www.swiggy.com/dapi/restaurants/list/update";
